    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="text-center mb-10" data-aos="fade-down">
            ...
            <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Laboratorium Fisika Medis dan Aplikasi Nuklir merupakan fasilitas penelitian dan pembelajaran yang berfokus pada pengembangan dan aplikasi teknologi dalam bidang medis dan nuklir.
            </p>
        </div>
            ...
            <div class="space-y-8" data-aos="fade-left" data-aos-delay="300">
                ...
                <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-emerald-500/20">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-emerald-500 transition-colors">Visi</h3>
                ...
                <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-emerald-500/20">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-emerald-500 transition-colors">Misi</h3>
                            <ul class="space-y-4">
